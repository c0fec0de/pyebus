...
def test_msgdefs0():
    ...
    assert list(msgdefs.resolve(["*/FlowTempDesired/temp1", "cc/StatPowerOn", "hc/FlowTemp*"])) == [
        ...
        MsgDef("mc.3", "FlowTempDesired", (FieldDef(0, "temp1", IntType(0, 100, divider=2), unit="°C"),), read=True),
        MsgDef("mc.4", "FlowTempDesired", (FieldDef(0, "temp1", IntType(0, 100, divider=2), unit="°C"),), read=True),
        MsgDef("mc.5", "FlowTempDesired", (FieldDef(0, "temp1", IntType(0, 100, divider=2), unit="°C"),), read=True),
        MsgDef("cc", "StatPowerOn", (FieldDef(0, "", IntType(0, 65534)),), read=True),
    ]
    ...
    assert list(msgdefs.resolve(["mc.5/Timer.*/to*"])) == [
        MsgDef(
            ...
            "Timer.Friday",
            (
                FieldDef(1, "to.0", HourMinuteType(minres=10)),
                FieldDef(3, "to.1", HourMinuteType(minres=10)),
                FieldDef(5, "to.2", HourMinuteType(minres=10)),
            ),
            read=True,
            write=True,
        ),
